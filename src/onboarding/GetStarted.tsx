...
import GetStartedIllustration from '../assets/images/GetStartedIllustration.tsx';
  ...
  return (
    <SafeAreaView style= {styles.screen}>
      <View style = {styles.centerContent}>
          ...
          <Text style={styles.brand}><Text style={styles.brandAir}>CHI</Text><Text style={styles.brandAnime}>PY</Text></Text>
          <Text style= {styles.subtitle}>Feel the Magic of our Taste</Text>
          <Text style={styles.meta}>We have wide range of Deals to Offer<br>Find out what you like</br></Text>
